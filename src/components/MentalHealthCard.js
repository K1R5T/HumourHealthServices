...
import MentalHealthCardSingle from './MentalHealthCardSingle';
...
class MentalHealthCard extends Component {
    ...
    render() {
        const eachtip = this.state.mentaltips.map((tip, index) => {
            return <MentalHealthCardSingle
                key={index}
                title={tip.title}
                content={tip.content}
                src={tip.src} />
